                                ...
                                <form method="post" action="<?php echo base_url();?>Keranjang/Tambah" method="post" accept-charset="utf-8">
                                    ...
                                    <div class="text"><br>
                                        <div class="card-body">
                                            ...
                                            <br>
                                            <span>Dilihat   : <?php $data->count_view ?></span>
                                        </div>
                                        <div class="card-footer">
                                            <p class="buttons"><br>
                                                <a href="<?php echo base_url();?>Produk/Detail/<?php echo $data->id;?>" class="btn btn-default"> Lihat Detail</i>
                                                </a>
                                                ...
                                                <button type="submit" class="btn btn-sm btn-primary"><i class="fa fa-shopping-cart"></i> Beli</button>
                                            </p>
                                        </div>
                                    </div>
                                </form>
